    ...
    try:
        ...
        if skip_preprocessing:
            logger.info(
                ...
                "font/autofit/parçalama adımları atlanıyor",
                raw_size_mb, MEMORY_SAFE_PPTX_MB_THRESHOLD,
            )
            await status_msg.edit_text(
                f"⚠️ Dosya çok büyük ({raw_size_mb:.0f} MB) olduğu için "
                "bellek taşmasını önlemek amacıyla font/hizalama otomatik "
                "düzeltmeleri bu seferlik atlanıyor, doğrudan dönüştürülüyor..."
            )
        ...
        #    (Çok büyük dosyalarda parçalama işleminin kendisi de
        #    python-pptx ile tam dosya yüklemesi gerektirdiğinden atlanır;
        #    LibreOffice dosyayı tek seferde, kendi (daha hafif) süreciyle
        #    işler.)
        ...
        use_chunking = (
            not skip_preprocessing
            and ext in (".pptx", ".pptm", ".potx")
            and (
